...
export const cardProduct = (product) => {
    return `
        <div
            ...
            <a href="#">
                <img alt="product image" class="p-8 rounded-t-lg"
                     src="${product?.mainImage || imageHolder}" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                ...
                <div class="flex items-center justify-between">
                    <span class="text-3xl font-bold text-gray-900 dark:text-white">$${product?.price?.minPrice || '$0.00'}</span>
